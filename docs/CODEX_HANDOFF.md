...
- 0.1.58 解鎖後 live 驗收發現兩個獨立 FBA preparation 問題，Issue #221 正修正為 0.1.59：完整空 relationships 保留 provenance；精確符合目標的唯一既有 theme 原樣保留而非當成 parent 關係。保留已合併 PR #217，基準 `88577f87f3acd17b009fbf412523f71ba96cb047`。[spec](specs/2026-09-08-standalone-live-preparation.md)／[分層紀錄](releases/2026-09-standalone-live-preparation.md)。0.1.58 員工登入後 Mac／Windows 實際下載已核對；新版修正、整表匯出與 live acceptance 尚未完成。
