...
- Issue #258 已由 PR #259／main `38f9bed050e0d9d33a7e69df8d34c410d547e069` 合併 0.1.67：免原表價目表只隔離單列 `LISTING_IDENTITY_MISMATCH`，效期健檢分清 Amazon 官方供應天數與日期欄的不同語意。最終 3,794 tests、production audit 0、兩軸 review 各 0 open，四條 exact main CI、Pages HTML／11 個 JS／CSS、兩平台可信 artifact 與 Mac→Windows 下載卡上傳均已核對；Windows 首次測試等待失敗經診斷後唯一重跑成功。這台 Mac 仍安裝 0.1.66；0.1.67 可信 DMG 已唯讀掛載，尚未退出或換版，原生工具最新回報 Mac locked／自動解鎖失敗。0.1.66 啟動授權已由原生首頁與 Amazon 已連線畫面證明解除；兩項首次唯讀工作都已失敗，未重試。新版安裝、完整效期／銷速、免原表 XLSX 及其他原始實機驗收繼續保留；下載頁目前仍需員工登入，尚無 0.1.67 實際下載 bytes。每層證據見 [修正 spec](specs/2026-09-health-price-live-compat.md) 及 [帳本](releases/2026-09-health-price-live-compat.md)。
