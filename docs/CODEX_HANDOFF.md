...
- 0.1.60 已完成 exact main CI／兩平台可信 artifact／Mac 安裝與 Amazon 連線，原始 TPZ preparation 與實際 Preview 已到達，唯讀維度保留；Preview 又回報缺 Contains Liquid Contents 而未帶出輸入欄。Issue #228／[spec](specs/2026-09-08-variation-preview-required-fields.md) 以 0.1.61 修正 Preview requirement→CHILD PTD 補填流程，禁止自行預填 false。前版完整交付見 [0.1.60 帳本](releases/2026-09-single-market-theme-preservation.md)，本輪以 [0.1.61 帳本](releases/2026-09-variation-preview-required-fields.md) 為準；尚未宣稱 Preview VALID 或正式綁定。
