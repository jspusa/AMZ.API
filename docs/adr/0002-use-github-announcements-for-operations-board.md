...
This document records the v0.1.49／v0.1.50 historical design only. The Supply Boss implementation was released in v0.1.51 and no longer creates, edits, or closes GitHub Issues for board data. Legacy authorized issue triggers remain a separate Pages compatibility path.
