...
- 本輪使用者核准「變體工作台與 US 價目表」：變體改為寬版表格並可補填 CHILD PTD 缺少商品事實；本機價目表保留原檔，並排比對 Amazon 售價／最低價格與選配首圖。詳見 [spec](specs/2026-09-08-variation-price-workbench.md) 及 [本輪證據](releases/2026-09-variation-price-workbench.md)。目標 Notebook Key `0.1.57`；發布、安裝與 live 狀態依日期化帳本，不由 source 版本推定。
