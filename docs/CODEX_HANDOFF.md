...
- 0.1.62 已由 PR #235／main `9a71d8bd848266936cd387d729ec0b6fdd473eac` 完成兩軸 review、本機 check（297 files／3,321 tests、audit 0）、四條 exact main CI、全部 Pages bytes 及 Mac／Windows 可信 artifact 核對；Mac 正式版已安裝、vault 未變且 Amazon 已連線。原始 TPZ 的液體資料卡點已在相同 ASAR 實帳 Preview 通過：明示現有「否」、勾選原樣保留後通過；agent 未按正式綁定或原生確認。其後外部使用者互動後畫面顯示綁定已受理／待回查，GET 後可見目標 parent，但不能以此代替完整 canonical proof。舊回查按鈕只讀 family，無法結案；接續 Issue #236／[0.1.63 唯讀恢復 spec](specs/2026-09-10-variation-readback-recovery.md)，使用現有 durable record 驗收、禁止重送或製造新 mutation。0.1.62 分層證據見 [保留事實帳本](releases/2026-09-variation-preserved-required-facts.md)，0.1.63 檢查／發布／安裝以 [本輪帳本](releases/2026-09-variation-readback-recovery.md) 更新。Portal 目前仍是先前版本；0.1.62 未上傳，最終版本需兩卡更新與登入後實際下載驗證。
