...
- 使用者核准的「變體工作台與 US 價目表」已由 PR #214 合併並發布 `0.1.57`，release-code SHA `495ee23f11924777cac93ce43c9d487bfdd7ad2d`。四條 main Actions 成功、Pages bytes 相符、Mac／Windows artifact hash 已驗，員工下載檔已上傳。Mac 新版已暫存，因裝置鎖定尚未替換現有 `0.1.56`；登入後的受保護下載 hash 與 live Amazon 仍待驗。功能範圍與分層證據見 [spec](specs/2026-09-08-variation-price-workbench.md) 及 [本輪帳本](releases/2026-09-variation-price-workbench.md)，不可把發布推定為實機或 Amazon 成功。
